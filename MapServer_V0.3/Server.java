...
public abstract class Server {
    ...
    public Server(int port) {
        ...
        /*if (this instanceof StudentCode) {
		    StudentCode sc = (StudentCode) this;
		    String k = String.valueOf(sc.returnSendTot());
		    System.out.println("K VALUE RRR: " + k);
		    countryColors.put("totalPopulation", k);
		}*/
		/*sc = new StudentCode();
		String k = String.valueOf(sc.returnSendTot());
